...
{
    public class BondsMarketdataEntity : IBondEntity
    {
        /// <summary>
        ...
        /// Для режимов РЕПО - расчетная цена РЕПО предыдущего дня.
        /// </summary>
        ...
        /// <summary>
        /// Цена последней сделки к оценке предыдущего дня (изменения за день)
        /// </summary>
